...
export default function InventoryAdminPage() {
  ...
  async function updateStock(id: string) {
    const value = Math.max(0, Number(draft[id] ?? products.find(p => p.id === id)?.stock ?? 0) || 0);
